...
public class Item {
	...
	private static String[] fullbody = {"top","shirt","platebody","Ahrims robetop","Karils leathertop","brassard","Robe top","robe","Robe","robetop","platebody (t)","platebody (g)","chestplate","torso", "hauberk", "Dragon chainbody", "robe (t)", "plate"};
	/* Fullhat covers your head but not your beard. */
	private static String[] fullhat = {"cowl","med helm","coif","Dharok's helm","hood","Initiate helm","Coif","Helm of neitiznot","Armadyl helmet","Berserker helm", "Archer helm", "Farseer helm", "Warrior helm", "Void","tiara"};
	/* Fullmask covers your entire head. */
	private static String[] fullmask = {"helm (t)","full helm","mask","Verac's helm","Guthan's helm","Karil's coif","mask","Torag's helm", "Void", "sallet", "tiara", "full"};
