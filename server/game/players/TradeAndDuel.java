...
public class TradeAndDuel {
	...
	public void openTrade() {
		...
		/* who has @gre@"+o.getItems().freeSlots()+" free slots */
		c.getPA().sendFrame126(
				"Trading with: " + Misc.capitalize(c.playerName) + " ", 3417);
	...
	public boolean fromTrade(int itemID, int fromSlot, int amount) {
		...
		try {
			...
			o.getPA()
					.sendFrame126(
							"Trading with: " + Misc.capitalize(c.playerName)
									+ "", 3417);
			c.tradeConfirmed = false;
			o.tradeConfirmed = false;
			c.getItems().resetItems(3322);
	...
	public boolean tradeItem(int itemID, int fromSlot, int amount) {
	    int tradeSize = offeredItems.size();
	    Client o = (Client) PlayerHandler.players[c.tradeWith];
		if (o == null) {
			return false;
		}
	...
	private boolean exceedsLimit(int size) {
	    if(size >= Config.TRADE_LIMIT)
		return true;
	    return false;
	}
	...
	public void openDuel() {
		...
		c.getPA().sendFrame126(
				"Dueling with: " + Misc.capitalize(o.playerName) + " (level-"
						+ o.combatLevel + ")", 6671);
